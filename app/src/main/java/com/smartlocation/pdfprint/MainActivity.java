package com.smartlocation.pdfprint;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createPDFFile(String path) {
        ...
        try {
            ...
            document.addAuthor("Flora");
            document.addCreator("Mahmud");
            ...
            addNewItem(document, "26/10/2019", Element.ALIGN_LEFT, orderNumberValueFont);

            addLineSeperator(document);

            addNewItem(document, "Account Name", Element.ALIGN_LEFT, orderNumberFont);
            addNewItem(document, "Mr. A", Element.ALIGN_LEFT, orderNumberValueFont);
